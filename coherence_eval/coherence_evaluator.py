...
if __name__=="__main__":
    ...
    f = open('../rag_utility/doc_dicts/msmarco_passage_dict.pkl', 'rb')
    doc_dict = pkl.load(f)
    f.close()

    # load res file

    dl_19_res = pd.read_csv(f'../rag_utility/res/{_ret}_dl_19.csv')
    dl_20_res = pd.read_csv(f'../rag_utility/res/{_ret}_dl_20.csv')
